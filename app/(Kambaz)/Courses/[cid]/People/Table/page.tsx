   ...
   <Table striped>
    ...
    <tbody>
     ...
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-login-id">00432754S</td>
      <td className="wd-section">S101</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2020-10-01</td>
     ...
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-login-id">00347583S</td>
      <td className="wd-section">S101</td>
     ...
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-login-id">00347693S</td>
      <td className="wd-section">S102</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2020-10-01</td>
      <td className="wd-total-activity">00:34:44</td></tr>
    </tbody>
   </Table>
  </div> );}